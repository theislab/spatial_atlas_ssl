...
rule create_dataset:
    ...
    output:
        ...
        down_trainset=config['output_folder'] + config['adata_name'] + "/train_datasets/dataset_{k_hop}_{radius}_train.pt",
        down_valset=config['output_folder'] + config['adata_name'] + "/train_datasets/dataset_{k_hop}_{radius}_val.pt",
        down_testset=config['output_folder'] + config['adata_name'] + "/train_datasets/dataset_{k_hop}_{radius}_test.pt",
    shell:
        """
